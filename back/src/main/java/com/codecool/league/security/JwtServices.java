...
public class JwtServices {
    ...
    private String secretKey = "asgweheh54u5j4jw42sg2yhdshwyq43y";
...
//            log.debug("JWT token invalid " + e);
    ...
    /**
     * Parses the email and roles from the token. Since the token is signed we can be sure its valid information.
